...
class ContractScriptComplexityTest extends PropSpec with PropertyChecks with Matchers with TypedScriptGen {
  ...
  property("estimate contract script correctly") {
    ...
    ContractScript.estimateComplexity(V3, contract, ScriptEstimatorV2.apply) shouldBe Right((41, Vector(("first", 32), ("default", 20), ("third", 41))))
  }
  ...
  property("estimate contract script with context correctly") {
    ...
    ContractScript.estimateComplexity(V3, contract, ScriptEstimatorV2.apply) shouldBe Right((68, Vector(("first", 68), ("default", 30), ("third", 51))))
  }
  ...
  property("estimate contract script with context correctly 2") {
    ...
    ContractScript.estimateComplexity(V3, contract, ScriptEstimatorV2.apply) shouldBe Right((68, Vector(("first", 68), ("default", 30), ("second", 51))))
  }
}
